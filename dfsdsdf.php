...
//     // التحقق مما إذا كان الكود صالحًا ولم تنتهي صلاحيته
...
//         // تحديث حالة الموعد إلى "مؤكد" وحذف كود التحقق
//         $update_sql = "UPDATE appointments SET status = 'confirmed', confirmation_code = NULL WHERE id = ?";
//         $update_stmt = $conn->prepare($update_sql);
//         $update_stmt->bind_param("i", $appointment_id);
//         $update_stmt->execute();

//         // إرسال بريد إلكتروني بالتفاصيل
//         sendConfirmationEmail($email, $name, $phone, $service, $date, $time);
...
// وظيفة إرسال بريد إلكتروني بالتفاصيل
...
function sendConfirmationEmail($email, $name, $phone, $service, $date, $time) {
    ...
    try {
        ...
        $mail->Body = "
            ...
            <p>Please scan the following QR code to confirm your appointment:</p>
            <img src='data:image/png;base64,$barcodeBase64' alt='QR Code' style='width:200px;height:200px;'>
            <p>Thank you for choosing us!</p>
        ";
