<?php
    ...
    $redirect_url = isset($_GET['redirect']) ? $_GET['redirect'] : 'edit_product.php'; // رابط افتراضي إذا لم يتم تمرير أي رابط
    echo "<script>console.log('PHP Value: " . addslashes($redirect_url) . "');</script>";
